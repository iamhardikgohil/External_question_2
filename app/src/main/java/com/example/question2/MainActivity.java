...
import android.widget.Switch;import android.widget.Toast;
import com.google.android.material.bottomsheet.BottomSheetDialog;

public class MainActivity extends AppCompatActivity {
    private Switch switchSound, switchVibration, switchLED, switchBanners, switchContent, switchLockScreen;    private Button btnSave;
    ...
    private void showBottomSheet() {
        ...
        View bottomSheetView = getLayoutInflater().inflate(R.layout.bottom_sheet_confirmation, null);        	bottomSheetDialog.setContentView(bottomSheetView);
